...
Menu::macro('menu_admin', function () {
    return Menu::adminlteMenu()
        ...
        ->route('etl.show','<i class="fa fa-file-zip-o"></i><span>ETL</span>')
        // Usuarios
        ...
        ->add(Menu::new()->prepend('<a href="#"><i class="fa fa-floppy-o"></i><span>Backup</span> <i class="fa fa-angle-left pull-right"></i></a>')
            ->addParentClass('treeview')
            ->route('backup.import.show','<i class="fa fa-arrow-circle-up"></i><span>Importar</span>')->addClass('treeview-menu')
            ->route('backup.export.show','<i class="fa fa-arrow-circle-down"></i><span>Exportar</span>')
        )
