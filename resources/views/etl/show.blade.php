            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Archivo de carga de datos</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Archivo ETL</label>
                                <input type="file" id="exampleInputFile">

                                <p class="help-block">Por favor escoja el archivo generado por el sistema de
                                    facturación</p>
                            </div>
