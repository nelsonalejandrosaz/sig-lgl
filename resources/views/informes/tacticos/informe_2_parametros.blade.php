        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{route('tactico.2')}}">
                        @csrf
                        <div class="box-body">
                            {{--Fecha de inicio--}}
							...
							{{--Proveedor--}}
                             <div class="form-group">
                               ...
                               <select class="form-control">
                                        <option value="proveedor1">Cliente 1</option>
                                        <option value="proveedor2">Cliente 2</option>
                                        <option value="proveedor3">Cliente 3</option>
                                        <option value="proveedor4">Cliente 4</option>
                                </select>
