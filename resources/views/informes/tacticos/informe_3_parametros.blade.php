        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{route('tactico.3')}}">
                        @csrf
                        <div class="box-body">
                            {{--Fecha de inicio--}}
							...
							{{--Proveedor--}}
                             <div class="form-group">
                               ...
                               <select class="form-control">
                                        <option value="proveedor1">Vendedor 1</option>
                                        <option value="proveedor2">Vendedor 2</option>
                                        <option value="proveedor3">Vendedor 3</option>
                                        <option value="proveedor4">Vendedor 4</option>
                                </select>
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-lg btn-primary pull-right"><i class="fa fa-file"></i> Generar</button>
                        </div>
                    </form>
                </div>
