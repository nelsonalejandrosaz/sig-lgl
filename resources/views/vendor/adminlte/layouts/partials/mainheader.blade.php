...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <span class="logo-lg"><b>SIG</b> LGL</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                @else
                    ...
                    <li class="dropdown user user-menu" id="user_menu" style="max-width: 280px; white-space: nowrap;">
                        <!-- Menu Toggle Button -->
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="max-width: 280px;height: 50px;white-space: nowrap;overflow: hidden;overflow-text: ellipsis">
